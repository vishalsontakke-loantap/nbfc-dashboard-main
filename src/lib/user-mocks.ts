...
export const mockUsers: User[] = [
  ...
  },
  {
    ...
    permissions: ['pool_buyout.approve', 'pool_buyout.reject', 'loans.view', 'pii.view'],
    reportingTo: 'USR-005',
    location: 'Mumbai',
  },
  {
  ...
  },
  {
    ...
    permissions: ['pool_buyout.approve', 'pool_buyout.reject', 'loans.view', 'risk.view'],
    location: 'Bangalore',
  },
  {
    id: 'USR-006',
...
export const mockRoles: Role[] = [
  {
    ...
    permissions: [
      ...
      {
        module: 'Reports',
        actions: { view: true, create: true, edit: true, delete: true, approve: false },
      },
      {
        module: 'Audit Trail',
  ...
  },
  {
    ...
    permissions: [
      ...
      {
        module: 'Pool Buyout',
        actions: { view: true, create: true, edit: true, delete: false, approve: false },
      },
      {
        module: 'Loans',
        actions: { view: true, create: false, edit: false, delete: false, approve: false },
  ...
  },
  {
    ...
    permissions: [
      ...
      {
        module: 'Pool Buyout',
        actions: { view: true, create: false, edit: false, delete: false, approve: true },
      },
      {
        module: 'Loans',
        actions: { view: true, create: false, edit: false, delete: false, approve: false },
