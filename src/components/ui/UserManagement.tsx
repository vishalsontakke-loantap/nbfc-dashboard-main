...
const users = [
  ...
  },
  {
    id: 2,
    name: 'Priya Desai',
    email: 'priya.desai@bom.in',
    role: 'Admin',
    accessLevel: 'Bank Operations',
    lastLogin: '2024-10-23 08:45 AM',
    status: 'active',
  },
  {
    id: 3,
    name: 'Rahul Mehta',
    email: 'rahul.mehta@bom.in',
    role: 'Bank User',
    accessLevel: 'Read & Write',
    lastLogin: '2024-10-22 05:30 PM',
    status: 'active',
  },
  {
    id: 4,
    name: 'Suresh Kumar',
    email: 'suresh@muthoot.com',
    role: 'NBFC User',
    accessLevel: 'Partner Portal',
    lastLogin: '2024-10-23 10:00 AM',
    status: 'active',
  ...
  },
  {
    id: 5,
    name: 'Kavita Joshi',
    email: 'kavita@masfinance.com',
    role: 'NBFC User',
    accessLevel: 'Partner Portal',
    lastLogin: '2024-10-22 02:15 PM',
    status: 'active',
    nbfc: 'MAS Financial',
  },
  {
    id: 6,
    name: 'Dr. Anjali Rao',
    email: 'anjali.rao@audit.bom.in',
    role: 'Auditor',
    accessLevel: 'Read Only',
    lastLogin: '2024-10-21 11:20 AM',
    status: 'active',
  },
  {
    id: 7,
                        ...
                        <DialogContent>
                          ...
                          <div className="space-y-4">
                            ...
                            <div className="p-4 bg-blue-50 rounded-lg">
                              <h4 className="mb-2">Permissions for {selectedRole}</h4>
                            ...
                            <Button className="bg-[#0B5FFF] hover:bg-[#0B5FFF]/90">Save Changes</Button>
                          </div>
                        </DialogContent>
                      </Dialog>
                    </div>
