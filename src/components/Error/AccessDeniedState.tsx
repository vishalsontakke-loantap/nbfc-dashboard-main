...
export function AccessDeniedState({ onGoBack }: AccessDeniedStateProps) {
      ...
      <div className="bg-white rounded-[24px] shadow-lg max-w-[400px] w-full p-12">
        <div className="flex flex-col items-center text-center">
          ...
          <p className="font-['Poppins:Regular',sans-serif] text-[14px] text-[#62748e] mb-8 leading-relaxed">
            Looks like this page is off-limits. If you think you should have access, reach out to an admin.
          </p>
